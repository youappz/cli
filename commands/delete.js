...
module.exports = program => {
  ...
  output(
    'WARNING: Deleting this website will take down ' + program.website.url
  );
  output.blankLine();
  ...
  return inquirer
    ...
    .then(answers => {
      if (answers.name !== program.website.appId) {
        return Promise.reject(
          Error.create('Website name does not match', {formatted: true})
        );
      }
      ...
      return api
        ...
        .then(() => {
          output.blankLine();
          output('    Website has been deleted from YouAppz.');
